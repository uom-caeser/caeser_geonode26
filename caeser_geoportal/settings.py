...
from caeser_geoportal import get_version
from caeser_geoportal.celeryapp import app  # flake8: noqa
import djcelery
...
SECRET_KEY = os.getenv('SECRET_KEY', "#-)h9nh0eub=za+9leed_qx%ky(za3_rq=ja)@8i+3z8*hv0br")
...
ROOT_URLCONF = os.getenv('ROOT_URLCONF', 'caeser_geoportal.urls')
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'caeser_geoportal Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, caeser_geoportal',
